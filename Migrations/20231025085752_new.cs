    ...
    public partial class @new : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AcID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Registration = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    Model = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ICAOType = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PIC = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Night = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightLogs", x => x.FlightID);
                    table.ForeignKey(
